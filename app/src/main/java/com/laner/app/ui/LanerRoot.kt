...
/**
 * Product shell intentionally preserves the legacy RiftLab visual/interaction contract.
 * The refactor is below this layer: UI consumes Application services and never knows provider details.
 */
@Composable
fun LanerRoot(
    ...
    // Legacy product opened on LIVE; keep that behavior while the new Core owns truth.
